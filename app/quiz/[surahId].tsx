...
const styles = StyleSheet.create({
  ...
  comboText: { fontSize: 18, fontWeight: '900', color: '#D4AF37', letterSpacing: 1 },
  comboTextFire: { color: '#FF6B35', fontSize: 20 },
  ...
  comboMultiplierText: { fontSize: 12, fontWeight: '800', color: '#fff' },
  ...
  arabicDecor: { flexDirection: 'row', alignItems: 'center', marginBottom: 14 },
  arabicLine: { flex: 1, height: 1.5, backgroundColor: 'rgba(212,175,55,0.35)' },
  arabicDecorSymbol: { fontSize: 20, color: '#D4AF37', marginHorizontal: 12 },
  arabicText: {
    fontSize: 30,
    lineHeight: 54,
    textAlign: 'right',
  ...
  resultTitle: { fontSize: 28, fontWeight: '900', color: '#0D2818', marginTop: 16, letterSpacing: 0.5 },
  resultSurah: { fontSize: 16, color: '#6B7280', marginTop: 4 },
  resultScoreCircles: { flexDirection: 'row', gap: 6, marginTop: 16 },
  ...
  resultXPNumber: { fontSize: 32, fontWeight: '900', color: '#D4AF37' },
  resultXPLabel: { fontSize: 14, color: '#D4AF37', fontWeight: '600' },

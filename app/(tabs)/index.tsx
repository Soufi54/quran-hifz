...
const styles = StyleSheet.create({
  ...
  livesContainer: { flexDirection: 'row', gap: scale(3) },
  ...
  timerContainer: { flexDirection: 'row', alignItems: 'center', gap: scale(4) },
  timerText: { fontSize: fontScale(16), fontWeight: '700' },
  headerStreak: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: scale(4),
  ...
  headerStreakText: { fontSize: fontScale(14), fontWeight: '700', color: '#F97316' },
  timerBar: {
    height: scale(4),
  ...
  optionLetterText: { fontSize: fontScale(14), fontWeight: '700', color: '#374151' },
  optionText: {
    flex: 1,
  ...
  // Empty state
  emptyState: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: scale(40) },
  emptyIconCircle: {
    width: scale(96),
    height: scale(96),
  ...
  emptyTitle: { fontSize: fontScale(22), fontWeight: '700', color: '#0D2818', marginTop: scale(20) },
  emptyText: { fontSize: fontScale(15), color: '#6B7280', textAlign: 'center', marginTop: spacing.sm, lineHeight: fontScale(22) },
  emptyArrow: { marginTop: spacing.lg, opacity: 0.5 },

  // Done state
  doneContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: scale(40) },
  doneIconCircle: {
    width: scale(96),
    height: scale(96),
    borderRadius: scale(48),
  ...
  doneTitle: { fontSize: fontScale(28), fontWeight: '800', color: '#0D2818', marginTop: scale(20) },
  doneSubtitle: { fontSize: fontScale(15), color: '#6B7280', marginTop: spacing.sm },
  ...
  streakFlame: { marginBottom: scale(4) },
  streakNumber: { fontSize: fontScale(44), fontWeight: '900', color: '#F97316' },
  streakLabel: { fontSize: fontScale(14), color: '#6B7280', marginTop: scale(2) },
  ...
  multiplierText: { fontSize: fontScale(14), fontWeight: '700', color: '#D4AF37' },

  // Score circles
  scoreCircles: { flexDirection: 'row', gap: scale(10), marginTop: scale(20) },
  scoreCircle: {
    width: scale(36),
    height: scale(36),
  ...
  scoreText: { fontSize: fontScale(18), fontWeight: '600', color: '#374151', marginTop: spacing.sm + spacing.xs },
  ...
  xpEarnedNumber: { fontSize: fontScale(32), fontWeight: '900', color: '#D4AF37' },
  xpEarnedLabel: { fontSize: fontScale(18), color: '#D4AF37', fontWeight: '700' },
  ...
  streakCardNumber: { fontSize: fontScale(16), fontWeight: '700', color: '#F97316' },
